			...
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="images-column col-lg-6 col-md-12 col-sm-12 mob-h">
						...
						<div class="inner-column">
							<div class="image">
								<img src="assets/images/about/bo1.jpg" alt="" />
							</div>
							<!--
						<div class="image-one">
			...
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="images-column col-lg-6 col-md-12 col-sm-12 mob-h">
						...
						<div class="inner-column">
							<div class="image">
								<img src="assets/images/about/boi2.jpg" alt="" />
							</div>
							<!--
						<div class="image-one">
							<img src="assets/images/about/01.jpg" alt="" />
...
-->
					...
					<div class="row">
						<p class="text-center text">The Joe Niekro Foundation proudly acknowledges the philanthropy of
							...
							them with the Crystal Bat Award that acknowledges their generosity and their efforts.<br>
