   ...
   <?php include('nav.php'); ?>
    ...
    <div class="sidebar-page-container">
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                	<!-- Blog Single -->
                                 <div class="news-block-three">
                                    <div class="inner-box">
                                        <div class="image">
                                            <a href="https://bonicholslaw.com/blog/legalfactsaboutdivorce.php"><img src="../assets/images/blogs/divorcethings.jpg" alt=""></a>
                                        </div>
                                        <div class="lower-content">
                                           ...
                                           9 Legal Facts About Divorce You Should Know</h3>
                                            ...
                                            <div class="my-texttt">
                                                <div class="text">When a marriage ends, many changes often happen to spouses and their children. These can cause increased stress levels in both parties as they figure out how the divorce will
                                            ...
                                            <!--<a class="read-more" href="major-new-child.php">Read More</a>-->
                                              ...
                                              <div class="my-texttt">
                                                <div class="text">There are few true winners in divorce. The process is typically complicated, and both parties often come away less happy than they were before the marriage failed
                                                      <br><br>
        ...
        <h3>2.Your Decisions Should Be Based on Concrete Evidence</h3>
                                              <div class="my-texttt">
                                                <div class="text">The consequences of a divorce can be significant, and it's important to think about them before making any decisions. For example: should I keep the family
                                         ...
                                         <h3>3.You're Getting Divorced: Your Kids Aren't </h3>
                                              <div class="my-texttt">
                                                <div class="text">When you're in the heat of an argument, it's easy to say things that can hurt your spouse more than they already feel. Studies show children whose parents
                                              ...
                                              <div class="my-texttt">
                                                <div class="text">Divorce is tough, but you need to know what will happen in your case so that it doesn't come as a surprise. The information and advice
                                 ...
                                 <h3>5.Forget the Past. Prepare for the Future. Be a "Big Picture" Person </h3>
                                              <div class="my-texttt">
                                                <div class="text">The divorce process can be painful and emotional, but it is possible to move on with your life after the marriage has ended. Do not let past mistakes linger 
                                  ...
                                  <h3>6.Court Is Not at All as We See on TV</h3>
                                              <div class="my-texttt">
                                                <div class="text">The divorce process can be painful and emotional, but it is possible to move on with your life after the marriage has ended. Do not let past mistakes linger for you or any family members to get what they deserve; 
                                    ...
                                    <h3>7.Consider Alternatives to Court </h3>
                                              <div class="my-texttt">
                                                <div class="text">When a couple is divorcing, they often resort to court-ordered mediation. This process of negotiating with your spouse and coming up with mutual agreements can be much more amicable
                                    ...
                                    <h3>8.Stay Honest with Your Attorney & Your Spouse</h3>
                                              <div class="my-texttt">
                                                <div class="text">Hiding facts from your attorney will only hurt you in court. They need all key information, and if they don't have it, things can get tricky 
...
begin or else risk having their settlement denied because either party didn't give accurate accountings during negotiations leading up until filing suit against one another (known legally here).
                                       ...
                                       <h3>9.Have Reasonable Expectations</h3>
                                              <div class="my-texttt">
                                                <div class="text">Sometimes, couples in divorce have completely unreasonable goals or are inconsistent with the law. If you want your case resolved quickly, it's important 
