    ...
    <div class="page-wrapper">
        ...
        <section class="page-title" style="background-image:url(../assets/images/blogs/blog-single.jpg)">
            <div class="auto-container">
                <div class="clearfix">
                    <div class="pull-left">
                        <div class="text"> What Are the Rights of Parents for Child Custody After Divorce</div>
                    </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="news-block-three">
                            <div class="inner-box">
                                <div class="image">
                                    <a href=""><img src="../assets/images/blogs/childcustodyafterdivorce.jpg" alt=""></a>
                                </div>
                                <div class="lower-content">
                                    ...
                                    <h3>Understanding Child Custody Laws</h3>
                                    <div class="my-texttt">
                                        <div class="text">Child custody is the place where your children live after
                                    ...
                                    <div class="my-texttt">
                                        <div class="text">Physical custody is the right to allow your children to live
                                    ...
                                    <h3>Joint Physical Custody</h3>
                                    <div class="my-texttt">
                                        <div class="text">Courts often prefer joint physical custody to ensure that
                                    ...
                                    <h3>These are questions you should ask about joint physical custody.</h3>
                                    <div class="my-texttt">
                                        <div class="text">
                                            <ul>
                                                <li style="list-style:disc">How will you and your ex-spouse divide your
                                                    children's time?
                                                </li>
                                                <li style="list-style:disc">What distance can you live without your
                                                    spouse?
                                                </li>
                                                <li style="list-style:disc">Are you planning to move to another area in
                                                    the near future?</li>
                                                <li style="list-style:disc">Are you prepared to have frequent
                                                    conversations with your ex-spouse?</li>
                                                <li style="list-style:disc">How important does it matter for you to play
                                                    an integral role in the lives of your children?</li>
                                            </ul>
                                            </ul>
                                            <br>
                                    ...
                                    <h3>Sole Physical Custody</h3>
                                    <div class="my-texttt">
                                        <div class="text">The children are in sole physical custody, meaning they live
                                    ...
                                    <br>
                                    <h3>These are some questions you can ask about sole physical custody</h3>
                                    <div class="my-texttt">
                                        <div class="text">
                                            <ul>
                                                <li style="list-style:disc">Who will be your children's home for the
                                                    rest of their lives?
                                                </li>
                                                <li style="list-style:disc">Are you concerned that it might be too
                                                    difficult for your children to have only physical custody?
                                                </li>
                                                <li style="list-style:disc">Stability is vital for your children.</li>
                                                <li style="list-style:disc">What level of involvement would you prefer
                                                    to have your ex-spouse in the upbringing of your children?</li>
                                    ...
                                    <br>
                                    <h3>Visitation Rights of the Parent Non-Custodial</h3>
                                    <div class="my-texttt">
                                        <div class="text">In sole physical custody arrangements, the visitation schedule
                                    ...
                                    <br>
                                    <h3>Visitation rights to Grandparents, Stepparents and Caretakers</h3>
                                    <div class="my-texttt">
                                        <div class="text">Each state has its own laws that allow grandparents,
                                    ...
                                    <h3>Legal Custody</h3>
                                    <div class="my-texttt">
                                        <div class="text">Legal custody allows you to make decisions about your child's
                                    ...
                                    <br>
                                    <h3>Third-Party Guardianship</h3>
                                    <div class="my-texttt">
                                        <div class="text">In some cases, close relatives or friends may seek custody.
                                    ...
                                    <h3>Final Words</h3>
                                    <div class="my-texttt">
                                        <div class="text">It doesn't matter what circumstances you are going through, it
